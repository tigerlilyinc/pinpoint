...
companies = [
  ...
  { :name => "Stitch Fix",
    ...
    :contact_name => "Katrina Lake", # Justin has no connections
  ...
  { :name => "Syntellia",
    ...
    :contact_name => "Kostas Eleftheriou", # Justin has no connections
  ...
  { :name => "Tagged",
    ...
    :contact_name => "Johann Schleier-Smith", # Justin has no connections
  ...
  { :name => "TellApart",
    ...
    :contact_name => "Julie Black", # Laura Powers is connected to their director of eng, Justin has no connections
  ...
  { :name => "Twitch.tv",
    ...
    :contact_name => "Justin Kan", # Justin has no connections
  ...
  { :name => "Typesafe",
    ...
    :contact_name => "Jonas Boner", # Justin has no connections
